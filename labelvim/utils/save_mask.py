...
def create_mask(
    image=None, annotations=None, label_map=None, include_img=False, mask_type="polygon"
):
    """
    ...
    for annotation in annotations:
        if mask_type == "polygon":
            ...
            for polygon in segmentation:
                ...
                cv2.fillPoly(
                    mask, [polygon], color=random_colors_palette[annotation["category_id"]].tolist()
                )
            ...
            cv2.rectangle(
                ...
                (x, y),
                (x + w, y + h),
                random_colors_palette[annotation["category_id"]].tolist(),
                2,
            )
